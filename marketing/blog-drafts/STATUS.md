...
| SIM swap attacks: how a stolen phone number can take over your kid's accounts | `sim-swap-attacks-kids-accounts.md` (lead photo `sim-card-held-fingers.jpg`, CardMapr.nl/Unsplash, license verified "Free to use under the Unsplash License", not Unsplash+) | ~640 words incl. headers (~2-3 min). Stat: FBI IC3 2025 Annual Report (covers calendar 2025, published 2026): SIM Swap reported losses $17,366,758, confirmed directly from the IC3 PDF (`ic3.gov/AnnualReport/Reports/2025_IC3Report.pdf`), not an aggregator. The 2025 SIM-swap complaint count was skipped because the PDF's table layout made it ambiguous to extract reliably. Under-20 SIM-swap figures were also skipped, since there were too few reported cases to be meaningful. Backlog mobile-security #2. Alternates back to mobile-security after the last two-track pick was screen-time (`autoplay-one-more-video-loop`, 2026-09-21). "Where Paxio fits" section says plainly that no on-device app can stop a carrier-side swap. Drafted 2026-09-25 by the scheduled task on branch `blog-draft/sim-swap-attacks-kids-accounts`, local preview at `preview-sim-swap-attacks-kids-accounts.html`. Pending review, not converted and not pushed. |
