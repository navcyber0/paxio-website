...
## Screen-time track, continued (added 2026-09-10)

| Title | File | Status |
|---|---|---|
| More screen time, better thinking? What an 8-year study actually found | `screen-time-research-hours-vs-what-they-do.md` (lead photo `screen-time-research-teen-headphones-desk.jpg`, Compare Fibre/Unsplash) | ~520 words (~2-3 min). Stat: University of Jyväskylä + University of Eastern Finland, PANIC study, published in *Pediatric Exercise Science*, Aug 11-17 2026 (DOI 10.1123/pes.2025-0083) — 8-year follow-up of 260 kids found higher cumulative screen time since childhood associated with better cognitive processing in adolescence; researchers' own caveat (correlation not causation, "what kind of things they do" matters more than duration) is the post's actual argument. Angle: healthy screen-time psychology / debunking the "more screen time = straightforwardly worse" assumption, grounded in the researchers' own framing rather than moral panic. Alternates back to screen-time track after the last in-pool topic (fake-app-clones, mobile-security track, 2026-09-03) — the pillar/checklist post (2026-09-07/08) isn't part of the two-track alternation this task rotates. Drafted 2026-09-10, reviewed via local preview page, pending review. |
